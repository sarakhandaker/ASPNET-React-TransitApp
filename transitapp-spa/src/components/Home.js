    ...
    return (
        <div className="container">
            ...
            <div class="row mt-3 p-5 text-center justify-content-center">
                ...
                <br />
                <a href="https://kingcounty.gov/depts/transportation/metro.aspx" class="btn btn-danger btn-raised btn-lg mt-3"><i class="fa fa-play"></i> Go To King County Metro Website</a>
            </div>
        </div >
    );
}
